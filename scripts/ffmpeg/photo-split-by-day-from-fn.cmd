...
IF NOT EXIST "%TARGET_SUB_FOLDER%" IF "%DRY_RUN%" == "0" MD "%TARGET_SUB_FOLDER%" 2>NUL:
REM
IF "%DRY_RUN%" == "0" MOVE "%SOURCE_FOLDER%\!HF_FILENAME!" "%TARGET_SUB_FOLDER%"
IF NOT "%DRY_RUN%" == "0" echo MOVE "%SOURCE_FOLDER%\!HF_FILENAME!" "%TARGET_SUB_FOLDER%"
REM
goto :eof
